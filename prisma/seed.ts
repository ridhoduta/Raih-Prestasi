...
async function seedStudents() {
    ...
    const studentsData = [
        { nisn: '1000000001', name: 'Ahmad Rizki', kelas: '10 IPA 1', angkatan: 2026, dateBirth: new Date('2008-01-10'), gender: Gender.L },
        { nisn: '1000000002', name: 'Budi Santoso', kelas: '10 IPA 2', angkatan: 2026, dateBirth: new Date('2008-02-14'), gender: Gender.L },
        { nisn: '1000000003', name: 'Citra Lestari', kelas: '10 IPA 3', angkatan: 2026, dateBirth: new Date('2008-03-18'), gender: Gender.P },
        { nisn: '1000000004', name: 'Dewi Anggraini', kelas: '10 IPS 1', angkatan: 2026, dateBirth: new Date('2008-04-11'), gender: Gender.P },
        { nisn: '1000000005', name: 'Eko Prasetyo', kelas: '10 IPS 2', angkatan: 2026, dateBirth: new Date('2008-05-22'), gender: Gender.L },
        { nisn: '1000000006', name: 'Fajar Nugroho', kelas: '11 IPA 1', angkatan: 2025, dateBirth: new Date('2007-06-17'), gender: Gender.L },
        { nisn: '1000000007', name: 'Gita Maharani', kelas: '11 IPA 2', angkatan: 2025, dateBirth: new Date('2007-07-20'), gender: Gender.P },
        { nisn: '1000000008', name: 'Hendra Wijaya', kelas: '11 IPS 1', angkatan: 2025, dateBirth: new Date('2007-08-03'), gender: Gender.L },
        { nisn: '1000000009', name: 'Indah Permata', kelas: '11 IPS 2', angkatan: 2025, dateBirth: new Date('2007-09-05'), gender: Gender.P },
        { nisn: '1000000010', name: 'Joko Saputra', kelas: '12 IPA 1', angkatan: 2024, dateBirth: new Date('2006-10-01'), gender: Gender.L },
        { nisn: '1000000011', name: 'Kartika Sari', kelas: '12 IPA 2', angkatan: 2024, dateBirth: new Date('2006-11-09'), gender: Gender.P },
        { nisn: '1000000012', name: 'Lukman Hakim', kelas: '12 IPS 1', angkatan: 2024, dateBirth: new Date('2006-12-12'), gender: Gender.L },
        { nisn: '1000000013', name: 'Maya Putri', kelas: '12 IPS 2', angkatan: 2024, dateBirth: new Date('2006-04-25'), gender: Gender.P },
    ];
...
function generateAnswerValue(field: any, student: any) {
    switch (field.fieldType) {
        case 'TEXT': return { answer: `${student.name} ${field.label}` };
        case 'TEXTAREA': return { answer: `Jawaban untuk ${field.label}` };
        case 'NUMBER': return { answer: Math.floor(Math.random() * 100).toString() };
        case 'DATE': return { answer: student.dateBirth.toISOString() };
        case 'FILE': return { url: 'https://example.com/document.pdf', filename: 'document.pdf' };
        case 'SELECT':
        case 'RADIO': {
            const options = Array.isArray(field.options) ? field.options : JSON.parse(JSON.stringify(field.options || []));
            return { answer: options[0] || 'Pilihan' };
        }
        case 'CHECKBOX': {
            const options = Array.isArray(field.options) ? field.options : JSON.parse(JSON.stringify(field.options || []));
            return { answer: [options[0] || 'Ya'] };
        }
        default: return { answer: 'Default Answer' };
    }
}
    ...
    for (const student of students) {
        ...
        for (let i = 0; i < achievementCount; i++) {
            ...
            const gradeCompetition = gradeCompetitions.find(
                (gc: any) => gc.gradeCompetitionName === competition.level.name
            );
